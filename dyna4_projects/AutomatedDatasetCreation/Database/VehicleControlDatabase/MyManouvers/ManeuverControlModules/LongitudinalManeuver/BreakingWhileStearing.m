...
Scheduler.Phase{1}.PhaseInfo.Description.v = 'Drive Straight';
...
Scheduler.Phase{1}.PhaseInfo.Length.v = 4;
...
Scheduler.Phase{1}.AdditionalInputs.InitialSpeed.v = 14;
...
Scheduler.Phase{2}.PhaseInfo.Description.v = 'Soft Break';
...
Scheduler.Phase{2}.PhaseInfo.Length.v = 1;
...
Scheduler.Phase{2}.DrivingTask.AccPedalPos.v = 0.1;
...
Scheduler.Phase{2}.DrivingTask.BrakePedalPos.v = 0.4;
...
Scheduler.Phase{3}.PhaseInfo.Description.v = 'Drive straight';
...
Scheduler.Phase{3}.PhaseInfo.Length.v = 4;
...
Scheduler.Phase{3}.DrivingTask.DrivingTask.v = 'Accelerator and brake inputs';

Scheduler.Phase{3}.DrivingTask.SubAccBrakeInputsTask.Comment = 'Accelerator and brake inputs task';
Scheduler.Phase{3}.DrivingTask.SubAccBrakeInputsTask.v = 'Accelerator and brake pedal';

Scheduler.Phase{3}.DrivingTask.AccPedalPos.Comment = 'Accelerator pedal position';
Scheduler.Phase{3}.DrivingTask.AccPedalPos.vUnit = '0_1';
Scheduler.Phase{3}.DrivingTask.AccPedalPos.v = 1;
Scheduler.Phase{3}.DrivingTask.AccPedalPos.ActualSelection = 'Constant';

Scheduler.Phase{3}.DrivingTask.BrakePedalPos.Comment = 'Brake pedal position';
Scheduler.Phase{3}.DrivingTask.BrakePedalPos.vUnit = '0_1';
Scheduler.Phase{3}.DrivingTask.BrakePedalPos.v = 0;
Scheduler.Phase{3}.DrivingTask.BrakePedalPos.ActualSelection = 'Constant';
...
Scheduler.Phase{4}.PhaseInfo.Description.v = 'Hard Break';
...
Scheduler.Phase{4}.PhaseInfo.Length.v = 5;
...
Scheduler.Phase{4}.DrivingTask.DrivingTask.v = 'Accelerator and brake inputs';

Scheduler.Phase{4}.DrivingTask.SubAccBrakeInputsTask.Comment = 'Accelerator and brake inputs task';
Scheduler.Phase{4}.DrivingTask.SubAccBrakeInputsTask.v = 'Accelerator and brake pedal';

Scheduler.Phase{4}.DrivingTask.AccPedalPos.Comment = 'Accelerator pedal position';
Scheduler.Phase{4}.DrivingTask.AccPedalPos.vUnit = '0_1';
Scheduler.Phase{4}.DrivingTask.AccPedalPos.v = 0;
Scheduler.Phase{4}.DrivingTask.AccPedalPos.ActualSelection = 'Constant';

Scheduler.Phase{4}.DrivingTask.BrakePedalPos.Comment = 'Brake pedal position';
Scheduler.Phase{4}.DrivingTask.BrakePedalPos.vUnit = '0_1';
Scheduler.Phase{4}.DrivingTask.BrakePedalPos.v = 1;
Scheduler.Phase{4}.DrivingTask.BrakePedalPos.ActualSelection = 'Constant';
